...
class SubjobAnalyzer:
   ...
   def _flood_fill_subjob(self, dag: nx.DiGraph, 
       ...
       while queue:
           ...
           for source, _, edge_data in dag.in_edges(current, data=True):
   ...
   def _trace_subjob_components(self, dag: nx.DiGraph, start_component: str, 
       ...
       """
       Legacy method - now uses flood-fill internally.
       Kept for backward compatibility.
       """
       return self._flood_fill_subjob(dag, start_component, boundary_components, set())
